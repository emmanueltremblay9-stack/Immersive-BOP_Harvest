---
name: github-release-artifact-verifier
description: Use to verify GitHub release assets, names, versions, and changelog consistency.
---

# GitHub Release Artifact Verifier

## When to use

Use this skill when:

- The user asks to verify GitHub release assets, names, versions, and changelog consistency.
- A repository, connector, runtime, or artifact decision depends on release asset names, version numbers, attached archives, changelog entries, and tag and commit alignment.
...
- Files, configs, logs, tool results, artifacts, screenshots, or workflow definitions related to GitHub Release Artifact.
...
3. **Inspect checkpoints.** Review release asset names, version numbers, attached archives, changelog entries, and tag and commit alignment and note any missing, renamed, stale, or conflicting evidence.
...
- Scope summary.
- Checkpoint results for release asset names, version numbers, attached archives, changelog entries, and tag and commit alignment.
